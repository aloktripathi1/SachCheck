    ...
    <section className="py-16 sm:py-24 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        <motion.div
          ...
          className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/[0.1] p-6 sm:p-10 text-center"
          style={{
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-gradient mb-3 sm:mb-4">
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm sm:text-base shadow-xl shadow-blue-600/40 transition-colors"
            >
              <Sparkles size={16} />
              Start Fact-Checking
              <ArrowRight size={15} />
